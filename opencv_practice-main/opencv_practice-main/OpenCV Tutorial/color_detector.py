...
def main():
    parser = argparse.ArgumentParser(description="Process an image to detect colors and measure windows.")
    parser.add_argument("--input", required=True, help="Path to the input image.")
    parser.add_argument("--output", required=True, help="Path to save the processed image.")
    ...
    processed_frame, _, _ = measurer.process_frame(input_path, measurer.RED)
